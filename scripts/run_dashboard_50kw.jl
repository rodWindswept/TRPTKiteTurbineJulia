# scripts/run_dashboard_50kw.jl
# Interactive 3D GLMakie dashboard — 50 kW scaled configuration.
#
# Usage:
...
println("50 kW config — rotor $(round(p.rotor_radius, digits=2)) m radius, hub $(round(h_hub, digits=1)) m, V_hub $(round(v_hub, digits=2)) m/s")
